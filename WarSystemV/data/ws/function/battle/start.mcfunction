...
execute as @a if predicate ws:3 run give @s leather_boots[dyed_color=16777215,enchantments={"feather_falling":1,"depth_strider":1,"soul_speed":1},attribute_modifiers=[{id:"movement_speed",type:"movement_speed",amount:.1,operation:"add_multiplied_total"}],custom_name={"bold":true,"italic":false,"text":"Zilgamesh's Boots"}] 1
